...
class Vector3D:
	...
	def __abs__(self) -> float:
		return float(f"{(self._x**2+self._y**2+self._z**2)**0.5:.2f}")
	...
	def dot(self, other) -> float:
		if isinstance(other, Vector3D):
			return float(self._x*other._x+self._y*other._y+self._z*other._z)
...
print(vector.__mul__(42))
print(vector.__rmul__(45))
print(vector.__truediv__(5))
